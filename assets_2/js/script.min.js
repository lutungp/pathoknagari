    ...
    function s(a) {
        return this.each(function() {
            var t = c(this),
                ...
                i = c.extend({}, u.DEFAULTS, t.data(), "object" == typeof a && a),
...
function(o) {
    ...
    function e(i) {
        return this.each(function() {
            var t = o(this),
                e = t.data("http://wartahtmldemo.friskamax.com/js/bs.tab");
            e || t.data("http://wartahtmldemo.friskamax.com/js/bs.tab", e = new s(this)), "string" == typeof i && e[i]()
        })
    }
    s.VERSION = "3.3.7", s.TRANSITION_DURATION = 150, s.prototype.show = function() {
        ...
        if (i || (i = (i = t.attr("href")) && i.replace(/.*(?=#[^\s]*$)/, "")), !t.parent("li").hasClass("active")) {
            var n = e.find(".active:last a"),
                a = o.Event("http://wartahtmldemo.friskamax.com/js/hide.bs.tab", {
                    relatedTarget: t[0]
                }),
                r = o.Event("http://wartahtmldemo.friskamax.com/js/show.bs.tab", {
                    relatedTarget: n[0]
                });
            if (n.trigger(a), t.trigger(r), !r.isDefaultPrevented() && !a.isDefaultPrevented()) {
                ...
                this.activate(t.closest("li"), e), this.activate(s, s.parent(), function() {
                    n.trigger({
                        type: "http://wartahtmldemo.friskamax.com/js/hidden.bs.tab",
                        relatedTarget: t[0]
                    }), t.trigger({
                        type: "http://wartahtmldemo.friskamax.com/js/shown.bs.tab",
                        relatedTarget: n[0]
                    })
                })
            }
...
function(s) {
    ...
    function l(n) {
        return this.each(function() {
            ...
            /* hidden semnetara menggaung collapse pada navbar */
...
function(t, e, s) {
    var i, n, a = "placeholder" in e.createElement("input"),
...
function() {
    ...
    e.getListeners = function(t) {
        ...
        var i, n = this.getListenersAsObject(t),
            a = "object" == typeof e;
        for (i in n) n.hasOwnProperty(i) && -1 === r(n[i], e) && n[i].push(a ? e : {
            listener: e,
            once: !1
        });
        return this
        ...
        var i, n, a = this.getListenersAsObject(t);
        for (n in a) a.hasOwnProperty(n) && -1 !== (i = r(a[n], e)) && a[n].splice(i, 1);
        return this
        ...
        var n, a, r = t ? this.removeListener : this.addListener,
            s = t ? this.removeListeners : this.addListeners;
        if ("object" != typeof e || e instanceof RegExp)
            for (n = i.length; n--;) r.call(this, e, i[n]);
        else
            for (n in e) e.hasOwnProperty(n) && (a = e[n]) && ("function" == typeof a ? r.call(this, n, a) : s.call(this, n, a));
        return this
        ...
        var i, n, a, r = this.getListenersAsObject(t);
        for (a in r)
            if (r.hasOwnProperty(a))
                for (n = r[a].length; n--;) !0 === (i = r[a][n]).once && this.removeListener(t, i.listener), i.listener.apply(this, e || []) === this._getOnceReturnValue() && this.removeListener(t, i.listener);
        return this
    ...
    function(i) {
        ...
        var a = function() {};
        t.removeEventListener ? a = function(t, e, i) {
            t.removeEventListener(e, i, !1)
        } : t.detachEvent && (a = function(e, i, n) {
    ...
    function(t) {
        ...
        function d(t) {
            ...
            if (e = t, "[object Array]" === r.call(e)) i = t;
                ...
                for (var n = 0, a = t.length; n < a; n++) i.push(t[n]);
            else i.push(t);
            return i
        }
    ...
    function(N) {
        N.fn.marquee = function(L) {
            return this.each(function() {
                var i, n, a, r, s, o = N.extend({}, N.fn.marquee.defaults, L),
                    l = N(this),
                    h = 3,
                ...
                if ("string" != typeof L) {
                    ...
                    if (o.duplicated && (o.duration = o.duration / 2), o.allowCss3Support) {
                        var m = document.body || document.createElement("div"),
                            ...
                            w = "",
                            C = "";
                        if (m.style.animation && (C = "@keyframes " + b + " ", d = !0), !1 === d)
    ...
    function(x) {
        ...
        x.rateit = {
            ...
            var t = x.type(f);
            if ("object" == t || void 0 === f || null == f) m = x.extend({}, x.fn.rateit.defaults, f);
            else {
        ...
        e.fn.twittie = function() {
            var t = arguments[0] instanceof Object ? arguments[0] : {},
                ...
                l = e.extend({
                    ...
                    dateFormat: "%b/%d/%Y",
                    template: "{{date}} - {{tweet}}",
                    apiPath: "http://wartahtmldemo.friskamax.com/api/tweet.php"
                }, t),
                r = function(t) {
                    for (var e = t.split(" "), i = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], n = {
                            ...
                            "%Y": t.getFullYear()
                        }, a = l.dateFormat, r = l.dateFormat.match(/%[dmbByY]/g), s = 0, o = r.length; s < o; s++) a = a.replace(r[s], n[r[s]]);
                    return a
                },
                s = function(t) {
                    for (var e = l.template, i = ["date", "tweet", "avatar", "url", "retweeted"], n = 0, a = i.length; n < a; n++) e = e.replace(new RegExp("{{" + i[n] + "}}", "gi"), t[i[n]]);
                    return e
                };
    ...
    function(i) {
        ...
        i(window).width() < 300 ? n.remove() : n.each(function() {
            var t = i(this),
    ...
    function(t, o) {
        ...
        function n(t, e) {
            ...
            this.$container.hasClass("no-mobile") ? this.$container.on(l.CONTAINER.NO_MOBILE_SHOWN, o.proxy(this.init, this)) : this.init(), o(window).on(l.WINDOW.RESIZE, function() {
                clearTimeout(i), i = setTimeout(o.proxy(n.init, n), 500)
            })
            /* memaksa menjalankan fungis init */
            this.init()
        }
        n.prototype.activateControl = function() {
            var n = this;
            this.$container.find('a[data-toggle="tab"]').off("http://wartahtmldemo.friskamax.com/js/show.bs.tab").on("http://wartahtmldemo.friskamax.com/js/show.bs.tab", function(t) {
            ...
            this.$control = this.$container.find(".control a").filter('[data-href="#' + this.$tab.attr("id") + '"]'), this.$ul = this.$tab.find("ul"), this.$li = this.$ul.find("li"), this.totalItems = this.$li.length, this.maxItems = t < 570 ? 2 : t < 720 ? 3 : t < 950 ? 4 : 6, this.resizeContent(), this.slideControl()
        }, o.fn[e] = function(t) {
            return this.each(function() {
