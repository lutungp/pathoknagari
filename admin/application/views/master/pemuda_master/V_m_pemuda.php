	  ...
	  <div class="row">
			<div class="col-md-12">
              ...
              <table id="datatable_1" class="table table-striped table-bordered table-hover dt-responsive" width="100%">
                    ...
                    <?php
                    $no = 1;
                    foreach ($pemuda->result() as $key => $row): ?>
                        <tr>
                          <td align=center><?php echo $no ?></td>
                          <td><?php echo $row->pegawai_nama; ?></td>
                          <td><?php echo $row->pegawai_jabatan; ?></td>
                          <td class="text-center">
                            <a href="<?php echo base_url('Pemuda-Edit/'.$row->pegawai_id)?>" class="btn btn-success">
                              <i class="fa fa-edit"></i> Edit
                            </a>
                            <a href="javascript:void(0)" class="btn btn-danger"
                            onclick="confirm_delete(<?php echo $row->pegawai_id?>, 'C_m_pemuda/pemuda_delete/')">
