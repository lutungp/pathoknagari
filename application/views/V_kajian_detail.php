          ...
          <div class="row">
             <div class="col-md-8">
                <div class="news_item shadow">
                   <div class="image">
                      <img src="<?php echo $kajian_detail['img_url'] . $kajian_detail['data'][0]['kajian_photo']?>" alt="Latest News" class="img-responsive">
                   </div>
             ...
             <div class="col-md-4">
                <aside class="sidebar whitebox">
                   <div class="widget heading_space">
                      <h4 class="text-capitalize darkcolor bottom20">Kajian Terbaru</h4>
                      <?php
                          $terbaru = "";
                          foreach ($kajian_terbaru['data'] as $keybaru => $valuebaru) {
                              $terbaru .= " <div class='bottom15'>
                                               <a href='javascript:void(0)' onclick='kajian_detail(this)' class='post' value='" . $valuebaru['kajian_id'] . "'>
                                                  <div class='row' style='font-size: 10px;'>
                                                  <img src='" . $kajian_detail['img_url'] . $valuebaru['kajian_photo'] . "' alt='post image'
                                                  style='width: 80px;height: 50px;'>
                                                      <div style='width: 200px;padding-left:10px;'>
                                                      " . $valuebaru['kajian_nama'] . "
                                                      </div>
                                                  </div>
                                               </a>
                                            </div> ";
