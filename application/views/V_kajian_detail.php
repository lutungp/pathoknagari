      ...
      <div class="row">
         <div class="col-sm-12">
            <div class="page-titles text-center">
               <h2 class="whitecolor font-light bottom30">Kajian Islami Terbaru</h2>
               <ul class="breadcrumb justify-content-center">
                 <li class="breadcrumb-item"><a href="beranda">Beranda</a></li>
                 <li class="breadcrumb-item active" aria-current="page">Kajian Islami Terbaru</li>
               </ul>
            </div>
         </div>
      </div>
         ...
         <div class="col-md-8">
            <div class="news_item shadow">
               ...
               <div class="news_desc text-left">
                  <h3 class="text-capitalize font-light darkcolor"><a href="kajian-detail">Next Large Social Network</a></h3>
