      ...
      <div class="row">
         <div class="col-sm-12">
            <div class="page-titles text-center">
               <h2 class="whitecolor font-light bottom30">Kajian Islam Terbaru</h2>
               <ul class="breadcrumb justify-content-center">
                 <li class="breadcrumb-item"><a href="beranda">Beranda</a></li>
                 <li class="breadcrumb-item active" aria-current="page">Kajian Islam Terbaru</li>
               </ul>
            </div>
         </div>
      </div>
...
<!-- Berita -->
<section id="Berita" class="bglight padding text-center">
   <div class="container">
      <div id="blog-measonry" class="cbp">
         <div class="cbp-item">
            <div class="news_item shadow">
               <a class="image" href="Kajian-detail">
                  <img src="assets/images/blog-measonry21.jpg" alt="Latest News" class="img-responsive">
               </a>
               <div class="news_desc">
                  <h3 class="text-capitalize font-light darkcolor"><a href="kajian-detail">Masih Tersimpan Semangat Toleransi</a></h3>
                  <ul class="meta-tags top20 bottom20">
                     <li><a href="#."><i class="fa fa-calendar"></i>Feb 14</a></li>
                     <li><a href="#."> <i class="fa fa-user-o"></i> admin </a></li>
                     <li><a href="#."><i class="fa fa-comment-o"></i>5</a></li>
                  </ul>
                  <p class="bottom35">Masjid Ad-Darojat adalah salah satu masjid Pathok Negara yang memiliki sisi historis yang kuat.
									  Karena masjid ini adalah satu-satunya masjid yan pernah diruntuhkan jepang.</p>
         ...
         <div class="cbp-item">
            <div class="news_item shadow">
               ...
               <div class="news_desc">
                  <h3 class="text-capitalize font-light darkcolor"><a href="kajian-detail">Sosok Inspiratif : "Kyai Muthohar"  </a></h3>
                  <ul class="meta-tags top20 bottom20">
                     <li><a href="#."><i class="fa fa-calendar"></i>Feb 16</a></li>
                     <li><a href="#."> <i class="fa fa-user-o"></i>admin</a></li>
                     <li><a href="#."><i class="fa fa-comment-o"></i>5 </a></li>
                  </ul>
                  <p class="bottom35">Kyai Muthohar adalah sosok figur yang dihormati, dikagumi dan menjadi inspirasi bagi para santrinya.
									 </p>
                  <a href="Kajian-detail" class="button btnsecondary">Baca Lengkap</a>
               </div>
            </div>
         </div>
         <div class="cbp-item">
            <div class="news_item shadow">
               ...
               <div class="news_desc">
                  <h3 class="text-capitalize font-light darkcolor"><a href="Kajian-detail">Soko Guru Arsitekur Jawa Kuno</a></h3>
                  <ul class="meta-tags top20 bottom20">
        ...
        <div class="cbp-item">
            <div class="news_item shadow">
               <a class="image" href="kajian-detail">
                  <img src="assets/images/Berita/ber8.jpg" alt="Latest News" class="img-responsive">
               </a>
               <div class="news_desc">
                  <h3 class="text-capitalize font-light darkcolor"><a href="kajian-detail">Angkringan : Media Dakwah Inovatif</a></h3>
                  <ul class="meta-tags top20 bottom20">
                     <li><a href="#."><i class="fa fa-calendar"></i>Feb 29</a></li>
                     <li><a href="#."> <i class="fa fa-user-o"></i> admin </a></li>
                     <li><a href="#."><i class="fa fa-comment-o"></i>5 </a></li>
                  </ul>
                  <p class="bottom35">Angkringan Masjarot adalah Salah satu kegiatan yang digagas Ikatan Pemuda Islam Babadan
			   sebagai media dakwah yang inovatif serta mengembangkan sentra UKM.</p>
                  <a href="kajian-detail" class="button btnprimary btn-gradient-hvr">Baca Lengkap</a>
               </div>
            </div>
         </div>
         <div class="cbp-item">
            <div class="news_item shadow">
               ...
               <div class="news_desc">
                  <h3 class="text-capitalize font-light darkcolor"><a href="kajian-detail" >Di Masjid Hatiku Terkait</a></h3>
                  <ul class="meta-tags top20 bottom20">
         ...
         <div class="cbp-item">
            <div class="news_item shadow">
               <a class="image" href="kajian-detail">
                  <img src="assets/images/Berita/ber6.jpg" alt="Latest News" class="img-responsive">
               </a>
               <div class="news_desc">
                  <h3 class="text-capitalize font-light darkcolor"><a href="kajian-detail" >Merchadise Logo Label</a></h3>
                  <ul class="meta-tags top20 bottom20">
                     <li><a href="#."><i class="fa fa-calendar"></i>Jan 14</a></li>
                     <li><a href="#."> <i class="fa fa-user-o"></i> admin </a></li>
                     <li><a href="#."><i class="fa fa-comment-o"></i>5 </a></li>
                  </ul>
                  <p class="bottom35">Masjid Ad-Darojat mengembangkan usaha mikro yang di support
				                      oleh karya anak muda masjid (IPIB) yang sangat inovatif.</p>
                  <a href="kajian-detail" class="button btnsecondary">Baca Lengkap</a>
               </div>
            </div>
         </div>
